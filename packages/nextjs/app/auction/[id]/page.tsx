...
const formatAUSD = (value: bigint | undefined) => {
  if (!value) return "0";
...
const AuctionDetail: NextPage = () => {
  ...
  const handleMintTokens = async () => {
    ...
    try {
      ...
      // Calcular AUSD a mintar (50% do valor do colateral para manter ratio seguro)
      // ETH a ~$3000, então 0.01 ETH = $30, mintamos $15 AUSD
      ...
      notification.success(`${usdcToMint} AUSD mintado com sucesso!`);
    } catch (error: any) {
  ...
  const handlePlaceBid = async () => {
    ...
    if (bidValue > currentBalance) {
      notification.error(
        `❌ Saldo insuficiente!\n\nVocê tem: ${formatEther(currentBalance)} AUSD\nLance: ${bidAmount} AUSD\n\nConverta ETH para AUSD primeiro`,
      );
      return;
    }
            ...
            <div className="card-body">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="font-bold">{formatAUSD(displayAuction.minDeposit * 2n)} AUSD</p>
                  <p className="text-xs opacity-60 mt-1">
                    Lance mínimo: {formatAUSD(displayAuction.minDeposit)} AUSD (50%)
                  </p>
                </div>
                <div>
            ...
            <div className="card-body">
              ...
              {!connectedAddress ? (
                ...
                <div className="space-y-4">
                    ...
                    <div className="card-body p-4">
                      ...
                      {(!usdcBalance || usdcBalance === 0n) && (
                        <>
                          ...
                          <p className="text-sm font-semibold mb-2">💰 Converter ETH → AUSD</p>
                          <p className="text-xs opacity-70 mb-3">Deposite ETH como colateral para obter AUSD</p>
                          ...
                          <p className="text-xs mt-2 opacity-60">💡 Ratio: 1 ETH ≈ 1,500 AUSD (50% do valor)</p>
                        </>
                      )}
                    </div>
                  </div>
                  ...
                  <div>
                    <label className="label">
                      <span className="label-text font-semibold">Valor do Lance (AUSD)</span>
                      <span className="label-text-alt">Máx: {formatAUSD(usdcBalance)} AUSD</span>
                    </label>
                  ...
                  <div className="alert alert-info">
                    <div className="text-xs">
                      ...
                      <ul className="list-disc list-inside space-y-1 opacity-80">
                        <li>Aprove o token AUSD primeiro</li>
                        <li>Dê seu lance em AUSD</li>
